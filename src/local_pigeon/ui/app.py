...
from local_pigeon.ui.theme import GEMINI_CSS, THEME_JS, CTRL_ENTER_JS, create_theme
from local_pigeon.ui.env_utils import save_env_var as _save_env_var_impl
...
def create_app(
    ...
    # Theme, CSS, and JS — extracted to ui/theme.py for maintainability
    gemini_css = GEMINI_CSS
    ctrl_enter_js = CTRL_ENTER_JS
    theme = create_theme()
    theme_js = THEME_JS
...
def _save_env_var(key: str, value: str) -> None:
    ...
    Delegates to ui.env_utils for the actual implementation.
    """
    _save_env_var_impl(key, value)
